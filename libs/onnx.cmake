if(NOT DEFINED ONNXRUNTIME_DIR)
    ...
    set(ONNXRUNTIME_DIR "${CMAKE_CURRENT_SOURCE_DIR}/lib/${ONNXRUNTIME_PREFIX}")
    ...
    if(NOT EXISTS "${ONNXRUNTIME_DIR}")
        ...
        file(ARCHIVE_EXTRACT INPUT "download/${ONNXRUNTIME_FILENAME}" DESTINATION "${CMAKE_CURRENT_SOURCE_DIR}/lib")
    endif()
endif()
